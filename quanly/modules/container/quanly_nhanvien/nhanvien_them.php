    ...
    <div class="row content__body__master">
        <div class="col l-12 c-12">
            ...
            <div class="form-input content__body-form">
                ...
                <input type="tel" name="sdt_nv" id="sdt_nv" maxlength="10" class="input-df content__body-form-input" required>
            ...
            <div class="form-input content__body-form">
                ...
                <input type="tel" name="cccd_nv" id="cccd_nv" maxlength="12" class="input-df content__body-form-input" required>
