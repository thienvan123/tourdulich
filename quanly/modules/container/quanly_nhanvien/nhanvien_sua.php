    ...
    <div class="row content__body__master content__body__master-info">
        <div class="col l-4 c-12">
            ...
            <div class="form-input content__body-form">
                ...
                <input type="tel" name="sdt_nv" id="sdt_nv" pattern="\d*" minlength="10" maxlength="10" value="<?php echo $nhanvien_row['sdt_nhanvien']?>"
                    class="input-df content__body-form-input" required>
            ...
            <div class="form-input content__body-form">
                ...
                <input type="tel" name="cccd_nv" id="cccd_nv" maxlength="12" value="<?php echo $nhanvien_row['cccd_nhanvien']?>"
                    class="input-df content__body-form-input" required>
