    ...
    <nav class="navbar">
        ...
        <ul class="navbar__list">
            <li class="navbar__list-item">
                <a href="?quanly=donvi&query=danhsach" class="navbar__list-item-link"><i class="ti-control-record" style="visibility: hidden"></i> Viễn Thông Tiền Giang</a>
            </li>
            <li class="navbar__list-item">
                <a href="?quanly=tour&query=danhsach" class="navbar__list-item-link"><i class="ti-angle-down"></i> Tour Du Lịch</a>
            ...
            <li class="navbar__list-item">
                <a href="?quanly=hotrokinhphi&query=danhsach" class="navbar__list-item-link"><i class="ti-angle-down"></i> Hổ Trợ Kinh Phí</a>
                <?php if($idhotro != 0)
                {?>
                <ul class="sub-navbar__list">
                    <li class="sub-navbar__list-item">
                        <a href="?quanly=hotrokinhphi&query=danhsach&idhotro=<?php echo $idhotro ?>" class="sub-navbar__list-item-link">Giai đoạn <?php echo $giaidoan ?></a>
                    </li>
                    <li class="sub-navbar__list-item">
                        <a href="?quanly=hotrokinhphi&query=chitiet&idhotro=<?php echo $idhotro ?>" class="sub-navbar__list-item-link">Thâm niên</a>
                    </li>
                    <li class="sub-navbar__list-item">
                        <a href="?quanly=hotrokinhphi&query=chitietnhanhotro&idhotro=<?php echo $idhotro ?>" class="sub-navbar__list-item-link">Danh sách nhận hỗ trợ</a>
                    </li>
                </ul>
                <?php
                } ?>
            ...
            <li class="navbar__list-item">
                <a href="modules/container/quanly_hdsd/hdsd_download.php?hdsdadmin=1" class="navbar__list-item-link"><i class="ti-download"></i> Hướng dẫn sử dụng Admin</a>
            </li>
            <li class="navbar__list-item">
                <a href="modules/container/quanly_hdsd/hdsd_download.php?hdsd=1" class="navbar__list-item-link"><i class="ti-download"></i> Hướng dẫn sử dụng User</a>
            </li>
        </ul>
    </nav>
</div>
